...
module AtHomeInVitroTestKit
    class RequestFhirBundleEntryValidation < Inferno::Test
      ...
      description %(
        This test validates each entry within the FHIR Bundle against their respective profiles defined in the At-Home In-Vitro Test Report Implementation Guide.
